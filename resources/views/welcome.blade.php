        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block ">
                ...
                @else
                    ...
                    <a href="#" class="text-sm text-gray-700 dark:text-gray-500 underline dropdown-toggle" data-bs-toggle="dropdown"> Log in</a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('login') }}">Employ Login</a></li>
                        <li><a class="dropdown-item" href="{{ route('student.login') }}">Student Login</a></li>
                      </ul>
                    @if (Route::has('register'))
                    <a href="#" class="text-sm text-gray-700 dark:text-gray-500 underline dropdown-toggle" data-bs-toggle="dropdown"> Register</a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('register') }}">Employ Register</a></li>
                        <li><a class="dropdown-item" href="{{ route('student.register') }}">Student Register</a></li>
                      </ul>
                    @endif
                @endauth
            </div>
